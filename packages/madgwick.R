...
require("data.table") # This dependency confers speed benefits, but it may be removed in the 
                      # future if necessary.
...
#-------------------------------------------------------------------------------------------
# Determine orientation quaternion given accelerometer and gyro data, as well as an initial
# quaternion. Returns a 4-column data table with q0 through q4.
